...
Replace the `public/images/adam_photo.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
